...
use crate::model::{
    CaptureEvent, CaptureEventKind, FollowAction, Lane, LaunchIntent, LaunchMode, Note, RegionContent,
    SessionClip, SessionClipContent, Song, StepData, SynthEngine, TICKS_PER_STEP, Track, TrackKind,
    TrackOutput,
};
...
mod tests {
    use super::*;
    use crate::model::{
        CurveShape, FilterRouting, FilterSlope, FilterType, LfoTarget, ModSlot, ModSource, ModTarget,
        SynthParams, SynthWaveform, TrineParams, WaveModSlot, WaveModSource, WaveModTarget, WaveParams,
    };
    ...
    use super::voice_dsp::waveform_sample;
