...
use builtin_fx::automatable_params_for_config;
...
use playlist_panel::{PlaylistDrag, PlaylistEditorTargets, draw_audio_clip_waveform, playlist_contents_ui};
use model::{
    AudioClip, AutomationLane, AutomationPoint, AutomationTarget, CurveShape, EffectParamKey,
    Lane,
    ProjectPlugin, Region, RegionContent, SendBus,
    SessionClipContent, SessionQuantize, Song,
    TICKS_PER_STEP,
    TakeFolder, TrackEffectConfig, TrackKind,
};
use plugin_host::{
...
mod tests {
    ...
    use crate::model::{SessionClip, Track};
